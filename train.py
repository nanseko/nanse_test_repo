...
def ArgParse():
    ...
    parser.add_argument('--attention_type', help='Generator attention module type', type=str, default='none', choices=['none', 'cbam', 'coord'])
    parser.add_argument('--attention_reduction', help='Attention channel reduction ratio', type=int, default=16)
    ...
    assert args.attention_reduction > 0
